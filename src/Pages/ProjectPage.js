      ...
      <div className="projectss">
        ...
        <section className="about-text">
          <div className="about-text-container">
            ...
            <div className="about-content" style={{ marginBottom: "2rem" }}>
              ...
              and a better society. We carefully observe trends and changes in the society
              and thoroughly search out a way to address these changes in the best way possible.
              These projects are aimed at a better Africa, hence, we are the
              change Africa wants to see.
            </div>
            <div className="about-content" style={{ marginBottom: "2rem" }}>
              We have the best teams with undying zeal and passion for Africa.
              They contribute time, knowledge, skill an influence to see that all ends of Africa
              gets aware of the environmental and physical changes.
            </div>
            <div className="about-header">
              <h2>Project Design Pattern</h2>
            </div>
            <div className="about-content">
              As much as we have a project Pattern, we are dynamic and we
              adopt a pattern that can reach a larger public. We follow three major procedures:
            </div>
          </div>
        </section>
        ...
        <div className="outer">
          <div className="first-details">
            ...
            <p>
              Change the inevitable, hence our team keeps track on changes and
              updates in the society through thorough and adequate research.
            </p>
          </div>
        </div>
      </div>
      <div className="first-section">
        <div className="outer">
          <div className="first-details">
            ...
            <p>
              We identify the challenges around us and brainstorm how to solve them.
            </p>
          </div>
        </div>
      </div>
